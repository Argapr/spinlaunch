  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/token-management/quick-launch" element={<QuickLaunchTokenPage />} />
        <Route path="/token-management/my-tokens" element={<MyTokensPage />} />
        <Route path="/token-management/create" element={<CreateTokenPage />} />
        <Route path="/token-management/create-liquidity-pool" element={<CreateLiquidityPoolPage />} />
        <Route path="/token-management/multisender" element={<TokenMultiSenderPage />} />
        <Route path="/token-management/affiliate" element={<AffiliateProgramPage />} />
        {/* Routes for submenu pages */}
        <Route path="/token-management/market-id/create" element={<CreateOpenBookMarketIDPage />} />
        <Route path="/token-management/raydium/lp-v4/burn" element={<BurnLPPoolPage />} />
        <Route path="/token-management/raydium/lp-v4/withdraw" element={<WithdrawLPPoolPage />} />
        <Route path="/token-management/spl-token/revoke-freeze" element={<RevokeFreezeAuthorityPage />} />
        <Route path="/token-management/spl-token/revoke-mint" element={<RevokeMintAuthorityPage />} />
        <Route path="/token-management/spl-token/revoke-mutable" element={<MakeTokenImmutablePage />} />
        <Route path="/token-management/update" element={<UpdateTokenMetaDataPage />} />
        <Route path="/token-management/spl-token/mint" element={<TokenMintPage />} />
        <Route path="/token-management/spl-token/burn" element={<TokenBurnPage />} />
        <Route path="/token-management/account-holders" element={<ManageTokenHoldersPage />} />
        <Route path="/token-management/spl-token/freeze-account" element={<FreezeAccountPage />} />
      </Routes>
    </Router>
  )
}
