...
<div className="bg-[#060136] text-white p-8 rounded-lg shadow-md mb-4">
                <div className="flex justify-between items-start">
                    <div className="w-2/3 pr-8">
                        <h1 className="text-4xl font-bold mb-8">Mint Token</h1>
                    ...
                    <div className="w-1/3">
                        ...
                        <div className="p-4">
                            ...
                            <ol className="list-decimal list-inside space-y-2">
                                ...
                                <li>To mint more you should use the wallet that created the Token (Authority)</li>
                                <li>Enter the quantity you want to mint</li>
                                <li>Click on Mint Token and confirm the Transaction</li>
                                <li>Wait a minute for it to be minted</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div className="bg-[#060136] text-white p-8 rounded-lg shadow-md mb-4">
                <h2 className="text-2xl font-bold mb-2">What is Token Mint?</h2>
                <p className="text-base font-medium">Token is a dApp that allows all users, without coding experience, to mint more supply of a solana token if they have the authority wallet.</p>
            ...
            <div className="bg-[#060136] text-white p-8 rounded-lg shadow-md mb-4">
                <h2 className="text-2xl font-bold mb-2">Is it Safe to Revoke the Mint Authority here?</h2>
