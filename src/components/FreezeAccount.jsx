...
const FreezeAccount = () => {
    ...
    return (
        <>
            ...
            <div className="bg-[#060136] text-white p-8 rounded-lg shadow-md mb-4">
                <div className="flex justify-between items-start">
                    <div className="w-2/3 pr-8">
                        <h1 className="text-4xl font-bold mb-8">Freeze Account</h1>
                        <form className="space-y-6 flex flex-col items-center">
                            ...
                            <div className='w-full'>
                                ...
                                <input type="text" className="w-full bg-indigo-900 border-2 border-[#57369e] rounded-lg p-3 flex items-center justify-between cursor-pointer placeholder:text-[#190544] placeholder:font-semibold" placeholder="address" />
                            </div>
                    ...
                    <div className="w-1/3">
                        ...
                        <div className="p-4">
                            ...
                            <ol className="list-decimal list-inside space-y-2">
                                ...
                                <li>Enter wallet address you want to freeze</li>
                                <li>Make sure you have the freeze authroity of the token</li>
                                <li>Click on Freeze Account and confirm the Transaction</li>
                                <li>Wait a minute for it to be frozen</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div className="bg-[#060136] text-white p-8 rounded-lg shadow-md mb-4">
                <h2 className="text-2xl font-bold mb-4">What is Freeze Account?</h2>
                <p className="text-base font-medium mb-4">Freeze Account is a feature that allows you to prevent malicious actor from affecting your token. Once frozen, the account will not be able to transfer the token. It is a feature that is built into the token itself.</p>
            </div>
            <div className="bg-[#060136] text-white p-8 rounded-lg shadow-md mb-4">
            ...
            <div className="bg-[#060136] text-white p-8 rounded-lg shadow-md mb-4">
                <h2 className="text-2xl font-bold mb-4">Is it Safe to Freeze account here?</h2>
                <p className="text-base font-medium mb-4">Yes, our tool is completely safe. Our dApp is audited and used by hundred users every month.</p>
            </div>
        </>
  );
};
