...
const [isOpen, setIsOpen] = useState(false);
    ...
    return (
        <>
            <div className="bg-[#060136] text-white p-8 rounded-lg shadow-md mb-4">
                <div className="flex justify-between items-start">
                    <div className="w-2/3 pr-8">
                        <h1 className="text-4xl font-bold mb-8">Burn Liquidity Pool</h1>
                    ...
                    <div className="w-1/3">
                        ...
                        <div className="p-4">
                            <h2 className="text-xl font-bold mb-4">How to Burn LP Pool?</h2>
                            <ol className="list-decimal list-inside space-y-2">
                                <li>Connect your Solana Wallet</li>
                                <li>How to Burn LP Pool?</li>
            ...
            <div className="bg-[#060136] text-white p-8 rounded-lg shadow-md mb-4">
                <h2 className="text-2xl font-bold mb-2">What is Burn Liquidity Pool?</h2>
                <p className="text-base font-medium mb-4">Burn LP is the process of removing tokens from circulation to reduce the total supply. This is often done by sending tokens to an inaccessible address, effectively removing them from circulation. The goal is to increase the value of the remaining tokens by reducing the available quantity.</p>
            </div>
            <div className="bg-[#060136] text-white p-8 rounded-lg shadow-md mb-4">
