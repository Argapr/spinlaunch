...
const MakeTokenImmutable = () => {
    ...
    return (
        <>
            <div className="bg-[#060136] text-white p-8 rounded-lg shadow-md mb-4">
                <div className="flex justify-between items-start">
                    <div className="w-2/3 pr-8">
                        <h1 className="text-4xl font-bold mb-8">Make Token Immutable</h1>
            ...
            <div className="bg-[#060136] text-white p-8 rounded-lg shadow-md mb-4">
                <h2 className="text-3xl font-bold mb-2">What is Make Token Immutable?</h2>
                <p className="text-base font-medium">Make Token Immutable is a dApp that allows all users, without coding experience, to Make immutable a token you have created.</p>
            ...
            <div className="bg-[#060136] text-white p-8 rounded-lg shadow-md mb-4">
                <h2 className="text-3xl font-bold mb-2">Is it Safe to Revoke the Mint Authority here?</h2>
...
export default MakeTokenImmutable;
