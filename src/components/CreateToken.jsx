        ...
        <div className="bg-[#060136] text-white p-8 rounded-lg shadow-md mb-4">
                <div className="flex justify-between items-start">
                    <div className="w-2/3 pr-8">
                        <h1 className="text-4xl font-bold mb-9">Solana Token Creator</h1>
                    ...
                    <div className="w-1/3">
                        ...
                        <div className="p-4">
                            <h2 className="text-xl font-bold mb-4">Create your own Solana Token in 5 minutes</h2>
            ...
            <div className="bg-[#060136] text-white p-8 rounded-lg shadow-md mb-4">
                <h2 className="text-2xl font-bold mb-2">What is Solana Token Creator?</h2>
            ...
            <div className="bg-[#060136] text-white p-8 rounded-lg shadow-md mb-4">
                <h2 className="text-2xl font-bold mb-2">What can Token Admin do?</h2>
            ...
            <div className="bg-[#060136] text-white p-8 rounded-lg shadow-md mb-4">
                <h2 className="text-2xl font-bold mb-2">Is it Safe to use Solana Token Creator here?</h2>
