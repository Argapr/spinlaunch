...
const RevokeFreezeAuthority = () => {
    ...
    return (
        <>
            ...
            <div className="bg-[#060136] text-white p-8 rounded-lg shadow-md mb-4">
                <div className="flex justify-between items-start">
                    <div className="w-2/3 pr-8">
                        <h1 className="text-4xl font-bold mb-8">Revoke Freeze Authority</h1>
            ...
            <div className="bg-[#060136] text-white p-8 rounded-lg shadow-md mb-4">
                <h2 className="text-3xl font-bold mb-2">What is Revoke Freeze Authority?</h2>
                <p className="text-base font-medium ">Revoke Freeze Authority is a dApp that allows all users, without coding experience, to revoke the freeze authority of a token you have created.</p>
            ...
            <div className="bg-[#060136] text-white p-8 rounded-lg shadow-md mb-4">
                <h2 className="text-3xl font-bold mb-2">Which wallet can I use?</h2>
                <p className="text-base font-medium mb-4">You can use any Solana Wallet as Phantom, Solflare, Backpack, etc.</p>
            </div>
            <div className="bg-[#060136] text-white p-8 rounded-lg shadow-md mb-4">
                <h2 className="text-3xl font-bold mb-2">Is it Safe to Revoke the Freeze Authority here?</h2>
                <p className="text-base font-medium mb-4">Yes, our tool is completely safe. It makes the Revoke Freeze Authority for you and does not have any access to your information. Our dApp is audited and used by hundred users every month.</p>
            </div>
        </>
  );
};

export default RevokeFreezeAuthority;
