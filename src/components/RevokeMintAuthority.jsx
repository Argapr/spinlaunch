...
const RevokeMintAuthority = () => {
    ...
    const tokens = [{ id: 1, name: "No Data Found" }];
    return (
        <>
                    ...
                    <div className="w-1/3">
                        ...
                        <div className="p-4">
                            <h2 className="text-xl font-bold mb-4">
                                How to make token immutable?
                            </h2>
                            <ol className="list-decimal list-inside space-y-2">
                                <li>Connect your Solana Wallet</li>
                                <li>Select the Token from your wallet</li>
                                <li>
                                    To Make token mutable you should use the
                                    wallet that created that Token (Authority)
                                </li>
                                <li>Click on Make Immutable</li>
                                <li>Accept the Transaction</li>
                                <li>
                                    Wait a second and the changes will be
                                    applied
                                </li>
                            </ol>
                        </div>
            ...
            <div className="bg-[#060136] text-white p-8 rounded-lg shadow-md mb-4">
                <h2 className="text-3xl font-bold mb-4">
                    What is Revoke Mint Authority?
                </h2>
                <p className="text-base font-medium">
                    Revoke Mint Authority is a dApp that allows all users,
                    without coding experience, to revoke the mint authority of a
                    token you have created.
                </p>
                <p className="text-base font-medium mb-4">
                    ...
                    audited by different developers teams and used by best
                    Solana Projects.
                </p>
            </div>
            <div className="bg-[#060136] text-white p-8 rounded-lg shadow-md mb-4">
            ...
            <div className="bg-[#060136] text-white p-8 rounded-lg shadow-md mb-4">
                <h2 className="text-3xl font-bold mb-4">
                    Is it Safe to Revoke the Mint Authority here?
                </h2>
                <p className="text-base font-medium mb-4">
                    Yes, our tool is completely safe. It makes the Revoke Mint
                    Authority for you and does not have any access to your
